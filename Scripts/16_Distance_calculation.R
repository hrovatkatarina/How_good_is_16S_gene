...
# Distance calculation between: ANI, 16S and V-regions vs core-genome tree (for boxplot, Fig. 1b).
...
for (genus in genera) {
  my_dir <- file.path("Data", genus, "Trees")
...
write.csv(distance_table, "Data/Coregenome_distance.csv")
...
write.csv(distance_tableJRF, 'Data/JRF_disatnce_ANI.csv', row.names = FALSE)
